...
```
```{r lcagof2, include = FALSE, cache = TRUE}
...
```
```{r mglca2, include = FALSE, cache = TRUE}
...
```
```{r mglca4f, include = FALSE, cache = TRUE}
...
gofglca(lca2, lca3, lca4, test = "boot", seed = 1)
```
```{r lcas2, include = FALSE, cache = TRUE}
gof1 <- gofglca(lca2, lca3, lca4, test = "boot", seed = 1)
```
...
```
```{r mlca2, include = FALSE, cache = TRUE}
...
```
```{r mlca_f, include = FALSE, cache = TRUE}
