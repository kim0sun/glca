...
#> Intercepts :
#>                    Class 1/3 Class 2/3
#> Group :<= HS          1.0634   -0.0811
#> Group :HIGH SCHOOL   -0.2979   -1.4240
#> Group :COLLEGE       -0.6686   -2.0173
#> Group :GRADUATE      -1.2872   -2.6492
#> 
#> Coefficients :
#> Class 1/3 Class 2/3 
#>    0.0834    1.1140 
...
#>           Class 1 Class 2 Class 3
#> Cluster 1 0.92995 0.06128 0.00877
#> Cluster 2 0.50891 0.34985 0.14125
#> 
#> 
#> Number of parameters : 20 
#> Number of groups : 45 
...
#> Cluster 2  0.5089  0.3498  0.1412
#> 
#> Rho (Y = 1) :
#>          ECIGT ECIGAR   ESLT EELCIGT EHOOKAH
...
#> Class 2 0.6564 0.8030 0.8735  0.2220  0.9561
#> Class 3 0.0880 0.0245 0.4379  0.0224  0.4655
plot(mlca)
```
...
#> Mean Prevalence for latent classes:
#>           Class 1 Class 2 Class 3
#> Cluster 1 0.89032  0.0199 0.08978
...
#> Class 1 / 3 :
#>                    Odds Ratio Coefficient  Std. Error  t value  Pr(>|t|)    
#> SCH_LEVHigh School     7.0439      1.9522      0.4185    4.665  3.33e-06 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
#> Class 2 / 3 :
